...
import { Brain, Mail, LogIn, KeyRound, UserRound, AlertCircle, Info } from 'lucide-react';
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        if (error) {
          // If the error is about the user already existing, offer a friendly message
        ...
        {emailSent && (
          <Alert className="bg-green-50 border-green-200 text-green-800">
            ...
            <AlertDescription className="text-green-700">
              Verification email sent! Please check your inbox and spam folder to complete sign up.
            </AlertDescription>
          </Alert>
        )}
